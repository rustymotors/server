 ...
 *
 */
export declare class ServerMessageHeader extends Serializable implements ISerializable {
    private length;
    private signature;
    private sequence;
    private flags;
...
export declare class ServerMessagePayload extends Serializable implements ISerializable {
    private messageId;
    getByteSize(): number;
    serialize(): Buffer;
