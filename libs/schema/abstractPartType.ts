...
export const abstractPartType = pgTable(
    "abstract_part_type",
    {
        ...
        parentAbstractPartTypeId: integer("parent_abstract_part_type_id").references((): AnyPgColumn => abstractPartType.abstractPartTypeId),
        ...
        schematicPicname2: varchar("schematic_picname2", { length: 9 }).default("VEH%d"),
        blockFamilyCompatibility: integer("block_family_compatibility").default(0),
        repairCostModifier: numeric("repair_cost_modifier", { precision: 100, scale: 7 }).default("1.0"),
        scrapCostModifier: numeric("scrap_cost_modifier", { precision: 100, scale: 7 }).default("1.0"),
        garageCategory: integer("garage_category").default(0),
    },
    (table) => {
        return {
            idIdx: uniqueIndex("abstract_part_type_id_idx").on(table.abstractPartTypeId),
            parentAbstractPartTypeIdIdx: uniqueIndex("parent_abstract_part_type_id_idx").on(table.parentAbstractPartTypeId),
