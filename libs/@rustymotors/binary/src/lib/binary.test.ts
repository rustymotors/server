...
describe('Binary Message Parsing', () => {
    ...
    describe('BytableBase', () => {
        it('should throw error when called directly', () => {
            ...
            expect(() => base.deserialize(Buffer.alloc(0))).toThrowError(
    ...
    describe('BytableContainer', () => {
        describe('Non-null-terminated mode', () => {
            ...
            it('should serialize with length prefix', () => {
                ...
                // First 4 bytes should be length (4), followed by "test"
                expect(serialized.length).toBe(8); // 4 bytes length + 4 bytes content
            ...
            it('should calculate correct serializeSize', () => {
                container.setValue('hello');
                expect(container.serializeSize).toBe(9); // 5 (content) + 4 (length prefix)
            });
        });
