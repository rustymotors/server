...
const ssl_options_1 = require("../src/services/@drazisil/ssl-options");
...
globals_1.describe('sslOptions()', () => {
    ...
    globals_1.it('will throw an error when unable to locate the certificate', async () => {
        ...
        await globals_1.expect(ssl_options_1._sslOptions(fakeConfig.certificate, 'testingSSLOptions')).rejects.toThrowError(/cert.pem/);
    });
});
