...
exports.GenericReplyMessage = void 0;
    ...
    deserialize(buffer) {
        try {
            ...
            if (error instanceof RangeError) {
                ...
                throw new TypeError(`[GenericReplyMsg] Unable to read msgNo from ${buffer.toString('hex')}: ${error}`);
            }
        }
...
//# sourceMappingURL=generic-reply-msg.js.map