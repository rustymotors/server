...
exports.GenericRequestMessage = void 0;
    ...
    deserialize(buffer) {
        try {
            ...
            if (error instanceof RangeError) {
                ...
                throw new TypeError(`[GenericRequestMsg] Unable to read msgNo from ${buffer.toString('hex')}: ${error}`);
            }
        }
...
//# sourceMappingURL=generic-request-msg.js.map