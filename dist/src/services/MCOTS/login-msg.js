    ...
    deserialize(buffer) {
        try {
            ...
            if (error instanceof RangeError) {
                ...
                throw new TypeError(`[LoginMsg] Unable to read msgNo from ${buffer.toString('hex')}: ${error}`);
            }
            throw new Error(`[LoginMsg] Unable to read msgNo from ${buffer.toString('hex')}, error unknown`);
        }
...
//# sourceMappingURL=login-msg.js.map