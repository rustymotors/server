...
class MCOTServer {
    ...
    async _login(connection, node) {
        ...
        const pReply = new generic_reply_msg_1.GenericReplyMessage();
        pReply.msgNo = 213;
        pReply.msgReply = 105;
        pReply.appId = connection.appId;
        const rPacket = new message_node_1.MessageNode(message_node_1.EMessageDirection.SENT);
