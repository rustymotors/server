...
const loginServer = require('./index');

test('retuns a valid customer id - d316cd2dd6bf870893dfbaaf17f965884e', () => {
  const { customerId, userId } = loginServer.npsGetCustomerIdByContextId('d316cd2dd6bf870893dfbaaf17f965884e');
...
test('retuns a valid customer id - 5213dee3a6bcdb133373b2d4f3b9962758', () => {
  const { customerId, userId } = loginServer.npsGetCustomerIdByContextId('5213dee3a6bcdb133373b2d4f3b9962758');
