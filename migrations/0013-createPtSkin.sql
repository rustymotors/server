...
CREATE INDEX if not exists sys_idx_pt_skin_part_type_pt_skin_12628 ON pt_skin (part_type_id);

CREATE INDEX if not exists sys_idx_pt_skin_skin_type_pt_skin_12636 ON pt_skin (skin_type_id);

CREATE UNIQUE INDEX if not exists sys_idx_sys_pk_12047_12048 ON pt_skin (skin_id);
-- +goose StatementEnd