...
import { getUserSessionByConnectionId, getUserSessionByCustomerId, setUserSession } from "../services/session.js";
...
export function processGameLogin(
    ...
    if (session) {
        ...
        console.log(`Setting persona ID to ${personaId} for ${session.customerId}`);
