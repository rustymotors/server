...
function personaDataHandler(socket, rawData) {
  ...
  const responses = {
    "503": function() {
      npsSelectGamePersona(socket, rawData);
    },
    "50F": function() {
      npsLogoutGameUser(socket, rawData);
    },
    "532": function() {
      npsGetPersonaMaps(socket, rawData);
    },
  };

  if (typeof responses[requestCode] != "function" || responses[requestCode]()) {
