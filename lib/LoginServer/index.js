...
function updateSessionKey(customerId, sessionKey, contextId, remoteAddress) {
    db.query(
        'INSERT INTO sessions (customer_id, session_key, context_id, remote_address) VALUES ($1, $2, $3, $4) ON CONFLICT (customer_id) DO UPDATE SET session_key = $2, context_id = $3, remote_address = $4',
        [customerId, sessionKey, contextId, remoteAddress],
        err => {
            if (err) {
                // Unknown error
                console.error(
