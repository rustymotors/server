...
export type TTCPConnectionHandler = ({ incomingSocket, config, log, }: {
    incomingSocket: ISocket;
    config: TConfiguration;
    log: TServerLogger;
}) => void;
export type THTTPConnectionHandler = (req: IncomingMessage, res: ServerResponse, config: TConfiguration, log: TServerLogger) => void;
...
export type TSocketDataHandler = ({ socket, processMessage, data, logger, config, connection, connectionRecord, }: {
    socket: ISocket;
...
export type TMessageProcessor = ({ data, connectionRecord, config, logger, connection, message, }: {
    data: Buffer;
    connectionRecord: TSocketWithConnectionInfo;
    config: TConfiguration;
    logger: TServerLogger;
...
export type TConnectionHandler = ({ incomingSocket, config, log, }: {
    incomingSocket: ISocket;
    config: TConfiguration;
    log: TServerLogger;
}) => void;
...
export type TServiceRouter = (args: TServiceRouterArgs) => Promise<TServiceResponse>;
