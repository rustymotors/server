...
This project is indexed by GitNexus as **server** (8459 symbols, 19818 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
