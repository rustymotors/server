import { CString, NPSMessage, sliceBuff } from "rusty-motors-shared";
...
export class PersonaRecord {
    ...
    private _gameSerialNumber: CString;
    timeOnline: number;
    timeInGame: number;
    extraData: Buffer;
    personaData: Buffer;
    ...
    constructor() {
        ...
        this._gameSerialNumber = new CString(33);
        this.timeOnline = 0;
        this.timeInGame = 0;
    ...
    deserialize(buffer: Buffer): PersonaRecord {
        ...
        offset += 4;
        this._gameSerialNumber.deserialize(sliceBuff(buffer, offset, 33));
        offset += 33;
    ...
    getGameSerialNumber() {
        return this._gameSerialNumber.toString();
    }

    setGameSerialNumber(serialNumber: string) {
        this._gameSerialNumber.set(serialNumber);
    }
}
