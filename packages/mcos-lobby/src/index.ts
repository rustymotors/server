...
import { GServiceResponse, NPSMessage, NPSUserInfo } from '../../mcos-shared/src/types/index.js'
 ...
 */
function npsSocketWriteIfOpen (conn: import("../../mcos-shared/src/index.js").TCPConnection, buffer: Buffer): import("../../mcos-shared/src/index.js").TCPConnection {
  const { sock } = conn
  if (sock.writable) {
 ...
 */
function decryptCmd (con: import("../../mcos-shared/src/index.js").TCPConnection, cypherCmd: Buffer): import("../../mcos-shared/src/index.js").TCPConnection {
  const s = con
 ...
 * @return {import("mcos-shared").TCPConnection}
 */
function encryptCmd (con: import("../../mcos-shared/src/index.js").TCPConnection, cypherCmd: Buffer): import("../../mcos-shared/src/index.js").TCPConnection {
  const s = con
 ...
 * @return {import("mcos-shared").TCPConnection}
 */
function sendCommand (con: import("../../mcos-shared/src/index.js").TCPConnection, data: Buffer): import("../../mcos-shared/src/index.js").TCPConnection {
  const s = con
...
export class LobbyServer {
   ...
   */
  async dataHandler (rawPacket: { connection: import("../../mcos-shared/src/index.js").TCPConnection; data: Buffer }): Promise<import("../../mcos-shared/src/index.js").TCPConnection> {
   ...
   */
  async _npsRequestGameConnectServer (connection: import("../../mcos-shared/src/index.js").TCPConnection, rawData: Buffer): Promise<NPSMessage> {
    log.trace(
 ...
 */
export async function receiveLobbyData (dataConnection: import('../../mcos-shared/src/types/index.js').BufferWithConnection): Promise<GServiceResponse> {
  try {
