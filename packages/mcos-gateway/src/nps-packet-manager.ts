...
import { LobbyServer } from '../../mcos-lobby/src/index.js'
import { LoginServer } from '../../mcos-login/src/index.js'
import { PersonaServer } from '../../mcos-persona/src/index.js'
import { toHex } from '../../mcos-shared/src/index.js'
...
export class NPSPacketManager {
  npsKey = ''
  msgNameMapping: Array<{id: number, name: string}>
   ...
   */
  async processNPSPacket (rawPacket: { connection: import("../../mcos-shared/src/index.js").TCPConnection; data: Buffer }): Promise<import("../../mcos-shared/src/index.js").TCPConnection> {
