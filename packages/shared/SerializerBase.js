...
export class SerializerBase {
     ...
     * @returns {Buffer}
     */
    static _serializeDouble(double) {
     ...
     * @returns {number[]}
     */
    static _deserializeCharArray(buf) {
     ...
     * @returns {number}
     */
    static deserializeDoubleBE(buf) {
     ...
     * @returns {Buffer}
     */
    static serializeDoubleBE(double) {
        const buf = Buffer.alloc(8);
     ...
     * @returns {string}
     */
    static _charArrayToString(charArray) {
        let str = "";
     ...
     */
    static verifyConnectionId(object) {
