...
describe('UserInfo', () => {
    ...
    it('can deserialize from a buffer', () => {        const ui = new UserInfo()
        const buffer = Buffer.from("01030058000000150000000944722042726f776e0001000000680000002f00000005000000a5ceffff0d45acffffffffff00d8ffff02000000000000001127000000000000090000000000000000010000000000000e6649", "hex")
