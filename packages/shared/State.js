...
export class McosEncryption {
     ...
     *                                                    for data packets.
     */
    constructor({ connectionId, commandEncryptionPair, dataEncryptionPair }) {
...
export class McosSession {
     ...
     *                                        session.
     */
    constructor({ connectionId, username, gameId, encryption }) {
        this.connectionId = connectionId;
 ...
 * @interface
 * @typedef {object} WrappedSocket
 * @property {module:NetConnectOpts.Socket} socket The socket.
 ...
 */
export function wrapSocket(socket, connectionId) {
    return {
        socket,
        connectionId,
    };
...
/**
 * @typedef {function} StateSaveFunction
 ...
 *
 * @property {Record<string, string>} filePaths A map of file ids to file paths.
 *
 * @property {Record<string, WrappedSocket>} sockets A map of connection ids to
 *                                                sockets.
 *
 * @property {Record<string, McosEncryption>} encryptions A map of connection ids
 *                                                     to encryption objects.
 *
 * @property {Record<string, McosSession>} sessions A map of connection ids to
 *                                               sessions.
 *
 * @property {Record<string, WrappedSocket>} queuedConnections A map of
 *                                                         connection ids to
 *                                                        queued connections.
 *
 * @property {Record<string, OnDataHandler>}
 *          onDataHandlers A map of handler functions for the onData event.
 *
 * @property {StateSaveFunction} save Calls the internal save function to save itself
 * @requires module:packages/interfaces/ServiceResponse
 */
export const State = {};
 ...
 */
export function createInitialState({ saveFunction = saveStateToDatabase }) {
    return {
        filePaths: {},
        sockets: {},
        encryptions: {},
 ...
 */
export function addOnDataHandler(state, port, handler) {
 ...
 *                                                       handler exists
 */
export function getOnDataHandler(state, port) {
 ...
 */
export function addSocket(state, socket) {
 ...
 */
export function getSocket(state, connectionId) {
 ...
 */
export function getSockets(state) {
 ...
 */
export function removeSocket(state, connectionId) {
    const sockets = state.sockets;
 ...
 */
export function addQueuedConnection(state, socket) {
 ...
 */
export function getQueuedConnections(state) {
 ...
 */
export function removeQueuedConnection(state, connectionId) {
    const queuedConnections = state.queuedConnections;
 ...
 */
export function addEncryption(state, encryption) {
 ...
 */
export function getEncryption(state, connectionId) {
 ...
 */
export function updateEncryption(state, encryption) {
    const encryptions = state.encryptions;
    encryptions[encryption.connectionId] = encryption;
    return {
        ...state,
 ...
 */
export function removeEncryption(state, connectionId) {
    const encryptions = state.encryptions;
 ...
 */
export function removeSession(state, connectionId) {
    const sessions = state.sessions;
 ...
 */
export function fetchStateFromDatabase() {
