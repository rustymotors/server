 ...
 * @returns {Buffer}
 */
export function serializeByte(byte) {
    const buf = Buffer.alloc(1);
 ...
 * @returns {Buffer}
 */
export function serializeDWord(dword) {
 ...
 * @returns {Buffer}
 */
export function serializeFloat(f) {
    const buf = Buffer.alloc(4);
 ...
 * @returns {boolean}
 */
export function deserializeBool(buff) {
 ...
 * @returns {number}
 */
export function deserializeByte(buff) {
 ...
 * @returns {number}
 */
export function deserializeWord(buff) {
 ...
 * @returns {number}
 */
export function deserializeDWord(buff) {
 ...
 * @returns {number}
 */
export function deserializeFloat(buff) {
 ...
 * @returns {string}
 */
export function deserializeString(buf) {
