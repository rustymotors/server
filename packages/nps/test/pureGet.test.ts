...
describe("getDWord", () => {
	it("returns the dword at the specified offset in little-endian format", () => {
		const bytes = Buffer.from([0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00]);
	...
	it("returns the dword at the specified offset in big-endian format", () => {
		const bytes = Buffer.from([0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02]);
...
describe("getNBytes", () => {
	it("returns the first n bytes of a buffer", () => {
		...
		expect(getNBytes(bytes, 4)).toEqual(Buffer.from([0x01, 0x02, 0x03, 0x04]));
		expect(getNBytes(bytes, 6)).toEqual(Buffer.from([0x01, 0x02, 0x03, 0x04]));
	});
});
