...
export class ShardEntry {
     ...
     */
    constructor(name, description, id, loginServerIp, loginServerPort, lobbyServerIp, lobbyServerPort, mcotsServerIp, statusId, statusReason, serverGroupName, population, maxPersonasPerUser, diagnosticServerHost, diagnosticServerPort) {
        this.name = name;
...
//# sourceMappingURL=shard-entry.js.map