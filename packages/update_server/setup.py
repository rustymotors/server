...
with open('update_server/__init__.py', 'r') as f:
    for line in f:
...
kwargs = {
    ...
    'author': 'Jo Becher',
    'author_email': 'jwbecher@gmail.com',
    'maintainer': 'Jo Becher',
    'maintainer_email': 'jwbecher@gmail.com',
    'url': 'https://github.com/_/update_server',
