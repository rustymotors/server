...
var SERVER_PERSONA_m_MsgLen = 50652

var personaServer

function initServer () {
  personaServer = net.createServer(function (sock) { // connection' listener
    ...
    sock.on('data', function (data) {
      ...
      var tmp = new Buffer(SERVER_PERSONA_m_MsgLen)
      // Set MsgID: 2 bytes
  ...
  personaServer.listen(SERVER_PORT_PERSONA, function () { // listening' listener
    console.log('server bound: ' + SERVER_PORT_PERSONA)
  })
}
